...
void Setup_Temp_Fan(void)
{
    ...
    while (enter_setup == 1)
    {
        ...
        {
                    setup_fan_temp++;
                    if (setup_fan_temp >= 110) setup_fan_temp= 110;      
        ...
        {
                    if (setup_fan_temp <= 51) setup_fan_temp = 51;
                    else --setup_fan_temp;
...
void Update_Setup_Fan_Screen(void)
{
    ...
    setup_fan_text[0] =(int) setup_fan_temp/100 + '0';
    setup_fan_text[1] = (int)(setup_fan_temp/10)%10 + '0';
    setup_fan_text[2] = (int)setup_fan_temp%10 + '0';
