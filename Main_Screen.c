...
void Update_Screen(void)
{
    ...
    alarm_time[1]  = (alarm_hour & 0x0f)+ '0';      
    alarm_time[3]  = (alarm_minute>>4)  + '0';    
    alarm_time[4]  = (alarm_minute & 0x0f)+ '0';     
    alarm_time[6]  = (alarm_second>>4)  + '0'; 
    alarm_time[7]  = (alarm_second & 0x0f)+ '0'; 
    ...
    Fan_Set_Temp_Txt[0] = setup_fan_temp/100 + '0';
    Fan_Set_Temp_Txt[1] = setup_fan_temp/10 + '0'; // add code here
    Fan_Set_Temp_Txt[2] = setup_fan_temp%10 + '0'; // add code here
    ...
    Volt_Txt[0]= ((int) volt) + '0';            // separeting the digits off volt to display on screen
    Volt_Txt[2]= ((int) volt)%10 + '0';
    Volt_Txt[3]= ((int)volt)/10 + '0';

    DC_Txt[0] = duty_cycle/100 + '0';
    DC_Txt[1] = duty_cycle/10 + '0';
    DC_Txt[2] = duty_cycle%10 + '0';
    RPM_Txt[0] = (int)(rpm/1000)%10  + '0';  // separating the digits of duty cycle to be displayed on screen
    RPM_Txt[1] = (int)(rpm/100)%10 + '0' ; 
    RPM_Txt[2] = (int)(rpm/10)%10 + '0';
    RPM_Txt[3] = (int)rpm%10 + '0';     
